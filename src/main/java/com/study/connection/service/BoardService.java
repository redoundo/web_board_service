...
public class BoardService {
     ...
     */
    public Map<String, Object> getIndexProps(ConditionDto condition){
     ...
     */
    public Map<String, Object> getViewProps(@NotNull @Min(1) Integer contentId){
        Map<String, Object> map = new HashMap<>();
     ...
     */
    public Map<String, Object> getModifyProps(@NotNull @Min(1) Integer contentId){
        Map<String, Object> map = new HashMap<>();
        ContentDto content = this.contentMapper.selectContent(contentId);
        map.put("content", content);
        String categoryName = this.categoryMapper.findCategoryName(content.getContentCategoryId());
